...
define("mode/cpp", function(require, exports, module) 
{
    ...
    this.getNextLineIndent = function(state, line, tab, tabSize, row) {
        ...
        var findMatchingBracketRow = function(str, lines, row, balance, direction) {
            ...
            return findMatchingBracketRow(str, lines, row, balance);
        }
        ...
        if (state == "start") {
            ...
            if (line.match(/,\s*$/)) {
                ...
                if (bracePos) {
                    ...
                    if (!line.match("\\" + complements[ firstCharAfter[1] ])) {
                        idx += 1;
                    }
